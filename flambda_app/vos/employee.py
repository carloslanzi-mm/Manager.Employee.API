...
class EmployeeVO:
    ...
    def __init__(self, data: dict = None, default_values=True):
        ...
        self.company_id = (
            data.get("company_id") if data and "company_id" in data else None
        )
        self.name = data.get("name") if data and "name" in data else None
        self.hourly_rate = (
            data.get("hourly_rate") if data and "hourly_rate" in data else None
        )
        ...
        self.updated_at = (
            data.get("updated_at") if data and "updated_at" in data else None
        )
        self.deleted_at = (
            data.get("deleted_at") if data and "deleted_at" in data else None
        )
    ...
    def __str__(self):
        ...
        """
        return (
            f"EmployeeVO(id={self.id}, uuid={self.uuid}, company_id={self.company_id}, name={self.name}, "
