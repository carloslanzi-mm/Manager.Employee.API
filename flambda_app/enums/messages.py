...
class MessagesEnum(IntEnum):
    """Enum class for defining messages with associated values, labels, and optional messages.

    Attributes:
        code (int): The numeric value associated with the enum member.
        label (str): The label describing the enum member.
        message (str): An optional message associated with the enum member.
    """
    def __new__(cls, value, label, message=''):
        """Creates a new instance of the MessagesEnum with an associated value, label,
        and optional message.

        Args:
            value (int): The numeric value associated with the enum member.
            label (str): The label describing the enum member.
            message (str, optional): An optional message associated with the enum member.
            Defaults to an empty string.

        Returns:
            MessagesEnum: The newly created enum member with the provided value, label, and message.
        """
    ...
    METHOD_NOT_IMPLEMENTED_ERROR = (5, 'common.error.method_not_implemented_error',
    ...
    LIST_ERROR = (11, 'common.error.list_error',
                  'Unable to return the list data, please review your request')
    ...
    # validation 31 - 50
    VALIDATION_ERROR = (31, 'common.error.validation_error',
                        'Validation error, please review your params: value (%s) for param (%s)')
    INVALID_ISO_DATE_ERROR = (32, 'common.error.invalid_iso_date',
                              'Invalid iso date value (%s) for param (%s)')
    ...
    # Events 101 - 200
    EVENT_NOT_REGISTERED_ERROR = (101, 'common.error.event_not_registered_error',
                                  'Event not registered')
    EVENT_REGISTERED_WITH_SUCCESS = (102, 'common.event_registered_with_success',
                                     'Event registered with success')
    EVENT_NOT_SENT_ERROR = 103, 'common.error.event_not_sent_error', 'Event not sent'
    EVENT_ALREADY_REGISTERED_ERROR = (104, 'common.error.event_already_registered_error',
                                      'Event already registered')
    EVENT_TYPE_UNKNOWN_ERROR = (105, 'common.error.event_type_unknown_error',
                                'Event type unknown: (%s)')
