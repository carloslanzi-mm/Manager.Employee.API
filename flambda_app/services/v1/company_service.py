...
from flambda_app.repositories.v1.redis.company_repository import CompanyRepository as RedisCompanyRepository
...
class CompanyService:
    ...
    def __init__(self, logger=None, mysql_connector=None, redis_connector=None, company_repository=None,
        ...
        if self.REDIS_ENABLED:
            ...
            # todo passar apenas connector
            # redis repository
            self.redis_company_repository = redis_company_repository if redis_company_repository is not None \
                else RedisCompanyRepository(redis_connection=self.redis_connector.get_connection())
    ...
    def get(self, request: dict, uuid):
        ...
        try:
            ...
            data = self.company_repository.get(
                value, key=self.company_repository.UUID_KEY, where=where, fields=fields
            )
    ...
    def create(self, request: dict):
        ...
        try:
            ...
            product_vo = CompanyVO(data)
            created = self.company_repository.create(product_vo)
    ...
    def update(self, request: dict, uuid):
        ...
        original_product = self.company_repository.get(uuid, key=self.company_repository.UUID_KEY)
        ...
        try:
            ...
            updated = self.company_repository.update(product_vo, uuid, key=self.company_repository.UUID_KEY)
    ...
    def delete(self, request: dict, uuid):
        ...
        try:
            ...
            updated = self.company_repository.soft_delete(value=uuid, key=self.company_repository.UUID_KEY)
